export const TOURS = [
    ...
    packages: [
      {
        ...
        price: 899,
        recommended: false,
        features: ["3 Nights Cruise", "Full Board Meals"],
      },
      {
        name: "Premium Cruise",
        price: 1199,
        recommended: true,
        features: ["4 Nights", "Private Guide", "Temple Tours"],
      },
      {
...

  {
    ...
    shortDesc:
      "Discover the majestic temples of Ramses II in comfort.",
    ...
    packages: [
      {
        ...
        price: 89,
        recommended: false,
        features: ["Shared Transport", "Professional Guide"],
      },
      {
        name: "Private Tour",
        price: 149,
        recommended: true,
        features: ["Private Vehicle", "Flexible Timing"],
      },
      {
        name: "VIP Sunrise",
        price: 199,
...

  {
    ...
    shortDesc:
      "Snorkeling, island trips & optional luxury yacht experiences.",
    image: "/red-sea.jpg",
    duration: "Full Day",
    location: "Hurghada",
    type: "Private / Group",
    ...
    packages: [
      {
        ...
        price: 59,
        recommended: false,
        features: ["Boat Trip", "Snorkeling Equipment", "Lunch"],
      },
      {
        name: "Luxury Yacht",
        price: 99,
        recommended: true,
        features: ["Private Yacht", "Premium Lunch", "Private Crew"],
      },
      {
        name: "VIP Private Charter",
        price: 249,
        recommended: false,
        features: [
          "Exclusive Boat",
