...
export default function Footer() {
  ...
  const [mounted, setMounted] = useState(false); // ✅ يمنع mismatch من إضافات المتصفح
        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-300 font-[var(--font-inter)]">
              <p className="flex items-center gap-3"><MapPin size={16} className="text-yellow-400" /> Luxor, Egypt</p>
              <p className="flex items-center gap-3"><Mail size={16} className="text-yellow-400" /> elkhazanytours@gmail.com</p>
              <p className="flex items-center gap-3"><Phone size={16} className="text-yellow-400" /> WhatsApp Available</p>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-300 font-[var(--font-inter)] mb-5">
              Get exclusive offers and luxury travel inspiration.
            </p>

            {/* ✅ ده الجزء اللي بيمنع mismatch */}
            {mounted ? (
